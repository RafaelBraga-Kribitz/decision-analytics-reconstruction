...
## Corpus Check
- 68 files · ~49,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 641 nodes · 692 edges · 56 communities (45 shown, 11 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8e74e1b`
...
3. `inject_flaws()` - 14 edges
4. `Module C — Probabilistic Forecasting and Scenario Research Engine` - 14 edges
5. `Module A — Population Modeling and Segmentation System` - 13 edges
6. `Module B — Resource Allocation Engine` - 13 edges
7. `_build_sample()` - 12 edges
8. `TestFlawTypes` - 12 edges
9. `run_export()` - 12 edges
10. `aggregate_media_reachability_by_segment()` - 12 edges
...
- `_build_sample()` --calls--> `build_segmentation_frame()`  [INFERRED]
...
Cohesion: 0.06
Nodes (34): _build_sample(), _load_cfg(), main(), Module A Streamlit dashboard (three tabs)., build_behavioral_features(), Behavioral feature engineering for Module A., build_demographic_features(), Demographic feature engineering for Module A. (+26 more)
...
Cohesion: 0.16
Nodes (15): build_segmentation_frame(), DBSCANNoiseFilter, KMeansSegmenter, _matrix(), Segmentation models: DBSCAN noise filter + KMeans segmenter., Run DBSCAN + KMeans and return per-row labels and summary metrics.      Paramete, TDD tests for segmentation models (DBSCAN + KMeans)., test_build_segmentation_frame_columns() (+7 more)
...
Cohesion: 0.15
Nodes (5): export_artifacts(), Contract column tests for the Module A batch export pipeline., Run the export pipeline once with a small sample and return artifact paths., Run the export pipeline once with a small sample and return artifact paths., Run the export pipeline once with a small sample and return artifact paths.
...
## Knowledge Gaps
- **330 isolated node(s):** `Module A package root.`, `Module A dashboard app package.`, `Module A Streamlit dashboard (three tabs).`, `TDD tests for segment_reachability_aggregate module.`, `When all three penetration means are equal, primary_reach_channel must be 'direc` (+325 more)
...
- **Why does `generate_population()` connect `Community 7` to `Community 1`, `Community 3`, `Community 6`, `Community 11`, `Community 13`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `run_export()` connect `Community 1` to `Community 3`, `Community 7`, `Community 8`, `Community 10`, `Community 14`, `Community 15`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `inject_flaws()` connect `Community 3` to `Community 1`, `Community 11`, `Community 13`?**
