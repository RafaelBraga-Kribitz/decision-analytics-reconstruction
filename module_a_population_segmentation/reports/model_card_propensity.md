...
- The single strongest feature (`department_logit_offset`) encodes the logit of those same TSJE department turnout rates.
...
- AUC ≈ 0.89 is **not a generalization metric** — in either the circular or the ablated variant. It does not represent out-of-sample discriminative ability on real voter-level data.
