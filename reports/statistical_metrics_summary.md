...
`pi=23.51` means: relaxing the $44M budget cap [VERIFIED — T11-2] by $1 would yield ~23.5 additional persuasion-adjusted contacts (constant marginal value across all budget scales).
