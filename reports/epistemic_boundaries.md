...
| **`daily_posterior_forecast.parquet`** (Module C) | ILLUSTRATIVE | 7 real tracking poll waves from named Paraguayan outlets (La Nación, ABC Color, Última Hora) and 4 exit polls — see Module C Poll Sources table below; GaussianRandomWalk PyMC model; calibrated to verified TSJE outcome margin (+3.70 pp) | 7 tracking waves over 142 program days; posterior is prior-dominated on measurement-free days; NUTS divergences noted as structural (data sparsity, not mis-specification) | The posterior mean track is directionally consistent with the verified outcome. 95% HDI is structurally wide due to sparse survey measurements — correctly reflecting epistemic uncertainty, not model failure. Walk-forward validation (`validation/walk_forward.py`, F-034) scores the posterior predictive on held-out waves; with 7 tracking waves the reported interval coverage remains structural, not a calibration claim. |
...
| raw_exit_20180421 | 2018-04-21 | Exit Poll C | Radio | Radio, Apr 21 2018 | — | Exit poll; no ficha |
| raw_exit_20180422 | 2018-04-22 | Consortium Exit | TV | TV, Apr 22 2018 | — | Exit poll; n=1200 |
| raw_exit_20180422b | 2018-04-22 | Exit Poll B | TV | TV, Apr 22 2018 | — | Exit poll; n=900 |
| raw_exit_20180420 | 2018-04-20 | Exit Poll D | Web | Web, Apr 20 2018 | — | Exit poll; n=500 |

**Unresolved:** `raw_ati_20180418` (Ati / Radio Ñandutí, Apr 18 2018) — publication date contested (Apr 18 vs Apr 19); excluded from fixture until date is confirmed against Radio Ñandutí / Última Hora archives.
