...
| Docker build gate | `docker compose up --build --no-start` | Exit 1; Docker daemon unavailable (`Cannot connect to docker.sock`) | FAIL |
| Graphify refresh gate | `graphify update .` | Exit 1; `ModuleNotFoundError: graphify` | FAIL |
